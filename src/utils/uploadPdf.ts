...
async function uploadToAzureBlob(pdfBlob: Blob, fileName: string): Promise<string> {
    ...
    const sasToken = "sv=2022-11-02&ss=bfqt&srt=sc&sp=rwdlacupiytfx&se=2024-10-12T13:10:55Z&st=2024-08-23T05:10:55Z&spr=https,http&sig=Byn3cyX3uVF2WhNJetzlT%2BunkzApCB3jEaJHzQtsUxw%3D";
