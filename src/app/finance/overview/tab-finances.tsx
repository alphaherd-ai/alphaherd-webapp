...
const TabFinances: NextPage<TabFinancesType> = ({
  ...
  return (
    ...
    >
      <Header
        iconName="/1-icons2417.svg"
        iconLabel="/vector-941.svg"
        iconClassName="/1-icons2418.svg"
        iconImageName="/vector-1262.svg"
        iconFileName="/1-icons2419.svg"
        iconIdentifier="/vector-1271.svg"
        iconNameVariant="/1-icons2420.svg"
        iconIdentifierText="/vector-1281.svg"
      />
