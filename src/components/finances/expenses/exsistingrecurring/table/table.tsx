                ...
                <div className="flex-col w-full pr-[16px] pl-[16px] pt-[20px]">
                    ...
                    <div>
                        ...
                        <div className=' flex text-gray-500 text-base font-medium  w-[3rem]'></div>
                                ...
                                <div className=' flex text-gray-500 text-base font-medium  w-[12rem]'>Items</div>
                                ...
                                <div className=' flex text-gray-500 text-base font-medium  w-[10rem]'>₹ 500
                                </div>
                                <div className=' flex text-gray-500 text-base font-medium  w-[10rem]'></div>
                                {/* <div className="w-1/12"></div> */}
                        </div>
                    ...
                    <ExsistingRecurringTotalAmount />
            </div>
            <ExsistingRecurringBottomBar />
        </div>
