...
const FinancesSalesTableBottombar = ({goOnPrevPage,goOnNextPage,startInd,endInd,totalLen}:{goOnPrevPage:()=>void,goOnNextPage:()=>void,startInd:number,endInd:number,totalLen:number}) => {
...
export default FinancesSalesTableBottombar;