        ...
        <>
            ...
            <div className="flex relative g-4 items-center justify-between pb-[27px]  text-gray-500 text-[28px] font-bold">
                ...
                <div className="flex">
                    ...
                    <div className="mr-4 h-11 px-6 py-2.5 rounded-[5px]  justify-center items-center flex border border-borderGrey border-dashed self-stretch justify-start items-center gap-2 flex">
