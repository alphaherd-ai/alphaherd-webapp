...
const TransactionsBlanceSheetNetBankingItemSales = () => {

  const transactionAmount = useSelector((state:any) => state.transactionAmount)
  console.log(transactionAmount)

  const totalMoneyIn = transactionAmount
    .filter((transaction:any) => transaction.mode === "Net Banking" && transaction.invoiceLink?.startsWith('SI'))
...
export default TransactionsBlanceSheetNetBankingItemSales