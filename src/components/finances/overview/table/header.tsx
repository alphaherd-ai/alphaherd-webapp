    ...
    return (
        ...
        <>
            <div className='flex w-full bg-white h-20  p-4 px-6  justify-between border-0 border-b border-solid border-borderGrey rounded-tl-lg rounded-tr-lg'>
                ...
                <div className='cursor-pointer flex items-center  h-7  p-2 mr-4 border border-solid border-gray-300 border-0.5 rounded-lg gap-3'>
                    ...
                    <Popover>
                        <PopoverTrigger>
                            <Button
                                variant="solid"
                                className="capitalize border-none bg-transparent rounded-lg p-0 cursor-pointer"
                            >
