...
const FinacesOverviewTableBottombar = ({goOnPrevPage,goOnNextPage,startInd,endInd,totalLen}:{goOnPrevPage:()=>void,goOnNextPage:()=>void,startInd:number,endInd:number,totalLen:number}) => {
