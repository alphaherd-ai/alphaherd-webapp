...
const RecordTransactionPopup: React.FC<PopupProps> = ({onClose, headerdata,initialInvoiceNo, balanceDue}) => {
  ...
  return (
    <div className="w-full h-full flex justify-center items-center    backdrop-blur-sm bg-white bg-opacity-50 z-50">
        <div className="w-[640px] rounded-md py-2 pb-8  px-8 bg-white  shadow border border-neutral-400 border-opacity-60 backdrop-blur-[60px] flex-col justify-start items-start gap-6 flex">
