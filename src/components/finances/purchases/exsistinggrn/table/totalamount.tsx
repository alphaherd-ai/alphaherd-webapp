...
import Popup from "./recordExistingGrnTransaction"

const ExsistingGrnTotalAmount = ({otherData}: any) => {
  ...
  return (
    <>
            ...
            <div className="w-full h-full  mr-4 flex flex-col border border-solid  border-borderGrey rounded-md">
...
export default ExsistingGrnTotalAmount