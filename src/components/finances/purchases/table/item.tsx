...
if(isLoading&&!data)return (<Loading/>)
 ...
 {purchase.type === FinanceCreationType.Purchase_Order && (
  <div className='w-[3rem] flex items-center'>
    <div className='absolute right-16 '>
      <Popover placement="left" showArrow offset={10}>
        <PopoverTrigger>
          <Button variant="solid" className="capitalize flex border-none rounded-lg ">  
            <div className='flex items-center '><Image src={Menu} alt='Menu' className='w-5  h-5' /></div>
          </Button>
        </PopoverTrigger>
