...
const InventoryProductStockTableHeader = () => {
        ...
        <>
            ...
            <div className='flex w-full bg-white h-20  p-4 px-6 mt-6 justify-between border border-solid border-gray-300 border-t-0.5 rounded-tl-lg rounded-tr-lg'>
                ...
                <div className='flex text-gray-500 items-center w-5/12'>
                    <div className={activeTab === 'Low Stock'
                        ...
                        : "flex items-center border border-solid border-gray-300 border-0.5 p-1 px-2 text-sm bg-gray-200 text-gray-500 rounded-tl-md rounded-bl-md"}
                        onClick={() => setActiveTab('Low Stock')}>Low Stock</div>
                    <div className={activeTab === 'Expired'
                        ...
                        onClick={() => setActiveTab('Expired')}>Expired</div>
                    <div className={activeTab === 'Expiring'
                        ? "flex items-center border border-solid border-gray-300 border-0.5 p-1 px-2 text-sm bg-black text-white"
                        : "flex items-center border border-solid border-gray-300 border-0.5 p-1 px-2 text-sm bg-gray-200 text-gray-500"}
                        onClick={() => setActiveTab('Expiring')}>Expiring</div>
                    <div className={activeTab === 'Excess'
                        ...
                        : "flex items-center border border-solid border-gray-300 border-0.5 p-1 px-2 text-sm bg-gray-200 text-gray-500 rounded-tr-md rounded-br-md"}
                        onClick={() => setActiveTab('Excess')}>Excess</div>
                </div>
