...
const DownloadPopup = ({ onClose, products }:any) => {
  ...
  const downloadPDF = () => {
    convertImageToBase64(logo, (base64Image: any) => {
      ...
      const fileName = `products_report_${startDate ? format(startDate, 'dd-MM-yyyy') : 'start'}_to_${endDate ? format(endDate, 'dd-MM-yyyy') : 'end'}.pdf`;
      doc.save(fileName);
    });
  };
    ...
    <div className="w-full h-full flex justify-center items-center fixed top-0 left-0 inset-0 backdrop-blur-sm bg-gray-200 bg-opacity-50 z-50">
      ...
      <div className='w-full flex flex-col gap-6'>
        ...
        <div className="flex-col justify-start items-start gap-2 flex">
          <div className="text-gray-500 text-xl font-medium">Download Product Report</div>
