            ...
            <div className="w-full mt-[25px] pt-8 bg-white rounded-[10px] border-0.5 border-solid border-neutral-400 flex-col justify-start items-start gap-8 flex">
                ...
                <div className="w-full justify-start items-start flex rounded-[10px]">
                    <div className="w-3/12 p-6 bg-white border-t border-solid border-0  border-r border-stone-300 flex-col justify-center items-start rounded-b-xl gap-4 flex ">
                        <div className="text-gray-500 text-[28px] font-bold ">₹899</div>
                    ...
                    <div className="w-3/12 p-6 bg-white border-t border-solid border-0 border-r border-stone-300 flex-col justify-center items-start gap-4 flex">
                        ...
                        <div className="text-gray-500 text-base font-medium ">Total Sales</div>
                    </div>
                    <div className="w-3/12 p-6 bg-white border-t border-solid border-0 border-r border-stone-300 flex-col justify-center items-start gap-4 flex">
                        <div className="text-gray-500 text-[28px] font-bold ">₹499</div>
                        <div className="text-gray-500 text-base font-medium ">Avg. Cost of products used</div>
                    </div>
                    <div className="w-3/12 p-6 bg-white border-t border-solid border-0 border-stone-300 flex-col justify-center items-start gap-4 flex rounded-b-xl">
                        <div className="text-gray-500 text-[28px] font-bold ">19%</div>
                        <div className="text-gray-500 text-base font-medium ">Average Profit Margin</div>
                    </div>
                </div>
            </div>
                ...
                <div className="w-6/12 bg-white mt-[25px] rounded-[10px] border-0.5  border-solid border-neutral-400 flex-col justify-center items-start flex">
                    <div className="w-full border-b border-solid border-0 border-stone-300">
                        <div className="w-full flex gap-2 items-center p-6 h-3/12">
                            ...
                            <div className="text-gray-500 text-base font-medium ">{service?.sacCode}</div>
                        </div>
                    </div>
                    <div className="w-full border-b border-solid border-0 border-stone-300 flex  gap-8">
                        <div className="w-6/12 p-6 border-r border-solid border-0 border-stone-300 flex-col items-center justify-between">
                            <div className="text-neutral-400 text-base font-medium ">Categories</div>
                        ...
                        <div className="w-6/12 p-6 flex-col items-center justify-between">
                            <div className="text-neutral-400 text-base font-medium ">Dispensing Fee</div>
                    ...
                    <div className="w-full">
                        <div className="w-full flex gap-2 items-center p-6 h-3/12">
                            ...
                            <div className="px-2 py-1.5 bg-gray-100 rounded-[5px] justify-center items-center gap-2 flex">
                                <div className="text-gray-500 text-base font-medium ">{service?.providers}</div>
                            </div>
                ...
                <div className="w-full flex p-6 bg-white items-start justify-between w-full border-0 border-b border-solid border-neutral-400 rounded-md">
                    ...
                    <div>
                        <div className='flex justify-evenly  w-full  items-center box-border bg-gray-100  h-12 py-4 border-b border-neutral-400 text-gray-500'>
                            <div className='flex text-gray-500 text-base font-medium px-6 w-1/7'>Product</div>
                            <div className='flex text-gray-500 text-base font-medium px-6 w-1/7'>Item Quantity</div>
                            <div className='flex text-gray-500 text-base font-medium px-6 w-1/7'>Batch Number</div>
                            <div className='flex text-gray-500 text-base font-medium px-6 w-1/7'>Expiry Date</div>
                            <div className='flex text-gray-500 text-base font-medium px-6 w-1/7'>Cost Price</div>
                            <div className='flex text-gray-500 text-base font-medium px-6 w-1/7'>Selling Price</div>
                            <div className='flex text-gray-500 text-base font-medium px-6 w-1/7'>Stock Level</div>
                        </div>
                        ...
                        {/* <div key={item.id} className='flex  items-center w-full  box-border py-4 bg-white  bg-white border border-solid border-gray-300 text-gray-400 border-t-0.5  '>
                            <div className='w-1/12 px-6 flex items-center text-neutral-400 text-base font-medium'>{item.name} Strips</div>
                            <div className='w-1/12 px-6 flex items-center text-neutral-400 text-base font-medium'>quantity</div>
