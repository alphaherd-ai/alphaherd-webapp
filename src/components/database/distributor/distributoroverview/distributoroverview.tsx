                ...
                <div className="w-6/12 bg-white mt-[25px] rounded-[10px] border-0.5  border-solid border-neutral-400 flex-col justify-center items-start flex">
                    <div className="w-full border-b border-solid border-0 border-stone-300">
                        <div className="w-full flex gap-2 items-center p-6 h-3/12">
                            ...
                            <div className="text-gray-500 text-base font-medium ">{distributor?.address}</div>
                        </div>
                    </div>
                    <div className="w-full border-b border-solid border-0 border-stone-300 flex  gap-8">
                        <div className="w-6/12 p-6 border-r border-solid border-0 border-stone-300 flex-col items-center justify-between">
                            <div className="text-neutral-400 text-base font-medium ">GSTIN: </div>
                            <div className="text-gray-500 text-base font-medium ">{distributor?.gstinNo}</div>
                        </div>
                        <div className="w-6/12 p-6 flex-col items-center justify-between">
                            <div className="text-neutral-400 text-base font-medium ">PAN Number: </div>
                            <div className="text-gray-500 text-base font-medium ">{distributor?.panNo}</div>
                        </div>
                    </div>
                    <div className="w-full border-b border-solid border-0 border-stone-300">
                        <div className="w-full flex gap-2 items-center p-6 h-3/12">
                            <div className="text-neutral-400 text-base font-medium ">Email: </div>
                            <div className="text-gray-500 text-base font-medium ">{distributor?.email}</div>
                        </div>
                    </div>
                    <div className="w-full">
                        <div className="w-full flex gap-2 items-center p-6 h-3/12">
                            <div className="text-neutral-400 text-base font-medium ">Phone Number: </div>
                            <div className="text-gray-500 text-base font-medium ">{distributor?.contact}</div>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full flex p-6 bg-white items-start justify-between w-full border-0 border-b border-solid border-neutral-400 rounded-md">
                    ...
                    <div>
                        <div className='flex justify-evenly  w-full  items-center box-border bg-gray-100  h-12 py-4 border-b border-neutral-400 text-gray-500'>
                            ...
                            <div className='flex text-gray-500 text-base font-medium px-6 w-1/8'></div>
                        </div>
