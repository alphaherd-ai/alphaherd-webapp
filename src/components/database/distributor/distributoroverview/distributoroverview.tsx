            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                        <Popover placement="left" showArrow offset={10}>
                            ...
                            <PopoverContent className="p-5 text-textGrey2 bg-white text-sm  font-medium flex flex-row items-start rounded-lg border-2 ,t-3 mt-2.5">
                ...
                <div className="w-full justify-start items-start flex rounded-[10px]">
                    ...
                    <div className="w-4/12 p-6  border-t border-solid border-0 border-r border-stone-300 flex-col justify-center items-start gap-4 flex">
                        <div className="w-fit  bg-[#EBEDFF] py-2 px-2 rounded-md">
                            <div className="text-[#3C50FF] text-[28px] font-bold ">₹{(distributor?.creditedToken || 0).toFixed(2)}</div>
                    ...
                    <div className="w-fit bg-[#FFF0E9] py-2 px-2 rounded-md">
                            ...
                            <div className=" text-[#FC6E20] text-base font-medium ">Last Date for items returns</div>
                        </div>
