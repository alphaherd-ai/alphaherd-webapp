        ...
        <div className="flex justify-center items-center h-full">
            ...
            <div className="flex flex-col justify-center items-start w-6/12 h-full">
                ...
                <div className="w-[353px] h-11 ">
                    <input className="w-full uppercase h-full text-neutral-400 text-base font-medium  px-2 focus:outline-none border border-solid border-[#A2A3A3] rounded-[5px] focus:border focus:border-[#35BEB1]" type="text" name="orgName" value={props.data.orgName} onChange={props.handleChange} />
