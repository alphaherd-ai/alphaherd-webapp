    ...
    return (
        ...
        <div className="w-[640px] h-[663px] p-8 bg-gray-100 rounded-[20px] shadow border border-neutral-400 border-opacity-60 backdrop-blur-[60px] flex-col justify-start items-start gap-6 flex">
                ...
                <div className="flex-col justify-start items-start gap-2 flex">
                    <div className="text-gray-500 text-xl font-medium ">Add Users to your Organisation</div>
                    <div className="text-neutral-400 text-base font-medium ">Enter their email ID to send invite</div>
                </div>
                <div className="self-stretch h-[87px] flex-col justify-start items-start gap-4 flex">
                    <div className="w-[576px] h-[27px] justify-start items-center gap-2 flex">
                        ...
                        <div className="grow shrink basis-0 self-stretch justify-end items-center gap-2.5 flex">
                            ...
                            <div className="text-right text-teal-400 text-base font-bold ">Copy invite link</div>
                        </div>
                    </div>
                    <div className="self-stretch justify-start items-center gap-2 flex">
                        <div className="grow shrink basis-0 h-11 bg-white rounded-[5px] border border-neutral-400 justify-start items-center gap-4 flex">
                            <input type="text" className="h-full w-full text-neutral-400 text-base font-medium " placeholder=" Enter emails, separated by commas" />
                        </div>
                        <div className="w-[132px] self-stretch px-4 py-2.5 bg-zinc-900 rounded-[5px] justify-start items-center gap-2 flex">
                            <div className="text-white text-base font-bold ">Send Invite(s)</div>
                        </div>
                    </div>
                </div>
                <div className="self-stretch rounded-[5px] border border-stone-300 justify-start items-start w-full flex flex-col">
                    ...
                    <div className='flex  items-center w-full  box-border py-4 bg-white border border-solid border-gray-300 text-gray-400 border-t-0.5  '>
                        ...
                        <div className='w-6/12 px-6 flex items-center text-neutral-400 text-base font-medium gap-2'>
                            ...
                            <div className="w-[57px] h-7 px-2 py-1.5 bg-emerald-50 rounded-[5px] justify-center items-center gap-2 text-green-600 text-sm font-medium ">Admin</div>
                        </div>
                    ...
                    <div className='flex  items-center w-full  box-border py-4 bg-white  bg-white border border-solid border-gray-300 text-gray-400 border-t-0.5  '>
                        ...
                        <div className='w-6/12 px-6 flex items-center text-neutral-400 text-base font-medium gap-2'>
                            <div className="w-[73px] h-7 px-2 py-1.5 bg-violet-100 rounded-[5px] justify-center items-center gap-2 flex text-indigo-600 text-sm font-medium ">Staff</div>
                            <div className="w-[57px] h-7 px-2 py-1.5 bg-gray-200 rounded-[5px] justify-center items-center gap-2 text-neutral-400 text-sm font-medium ">Admin</div>
                        </div>
                        <div className='w-2/12 px-6 flex items-center text-neutral-400 text-base font-medium'></div>
                    </div>
                    <div className='flex  items-center w-full  box-border py-4 bg-white  bg-white border border-solid border-gray-300 text-gray-400 border-t-0.5  '>
                        ...
                        <div className='w-6/12 px-6 flex items-center text-neutral-400 text-base font-medium gap-2'>
                            <div className="w-[73px] h-7 px-2 py-1.5 bg-violet-100 rounded-[5px] justify-center items-center gap-2 flex text-indigo-600 text-sm font-medium ">Veterinarian</div>
                    ...
                    <div className='flex  items-center w-full  box-border py-4 bg-white  bg-white border border-solid border-gray-300 text-gray-400 border-t-0.5  '>
                        ...
                        <div className='w-6/12 px-6 flex items-center text-neutral-400 text-base font-medium gap-2'>
                            <div className="w-[73px] h-7 px-2 py-1.5 bg-violet-100 rounded-[5px] justify-center items-center gap-2 flex text-indigo-600 text-sm font-medium ">Staff</div>
                            <div className="w-[57px] h-7 px-2 py-1.5 bg-emerald-50 rounded-[5px] justify-center items-center gap-2 text-green-600 text-sm font-medium ">Staff</div>
                        </div>
                        <div className='w-2/12 px-6 flex items-center text-neutral-400 text-base font-medium'></div>
                    </div>
                </div>
                <div className="self-stretch justify-end items-center gap-2.5 flex">
                    <div className="px-4 py-2.5 bg-zinc-900 rounded-[5px] justify-start items-center gap-2 flex">
                        <div className="text-white text-base font-bold ">Finish</div>
                    </div>
                </div>
            </div>
        </div >
